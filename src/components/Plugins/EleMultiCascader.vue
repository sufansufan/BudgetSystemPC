<template>
  <div class="cascader-wrapper">
    ...
    >
      ...
      <div v-click-outside="hidePopover" class="cascader-menu-wrapper">
        <ul v-for="(cas, index) in casTree" :key="index" class="el-cascader-menu cascader-menu">
          <li
...
export default {
  ...
  methods: {
    ...
    setPopperWidth() {
      ...
      const width = (160 + 1) * this.casTree.length
